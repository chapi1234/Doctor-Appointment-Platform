    ...
    <div>
        <div>
          <h3 className="text-[25px] leading-[30px] text-headingColor font-semibold flex itmes-center gap-2">About of 
            <span className="text-irisBlueColor font-bold text-[25px] leading-9">{name}</span>
          </h3>
        ...
        <div className="mt-12">
            ...
            <ul className="pt-4 md:p-5 ">
                {qualifications?.map((item, index) =>            <li key={index} className="p-4 rounded bg-[#fff9ea]">
                ...
                <li className="flex flex-col sm:flex-row sm:justify-between sm:items-end md:gap-5 mb-[30px]">
                    <div>
                        <span className="text-irisBlueColor text-[15px] leading-6 font-semibold">{formateDate("6-03-2016")}-{formateDate("09-08-2020")}</span>
            ...
            <ul className="pt-4 md:p-5 ">
                <li className="flex flex-col sm:flex-row sm:justify-between sm:items-end md:gap-5 mb-[30px]">
                    <div>
                        <span className="text-irisBlueColor text-[15px] leading-6 font-semibold">{formateDate("6-03-2011")}-{formateDate("09-08-14")}</span>

                        <p className="text-[16px] leading-6 font-medium text-textColor">PHD in Surgeon</p>
                    </div>
                    <p className="text-[14px] leading-5 font-medium text-textColor">Jima University , Jima.</p>
                </li>
            </ul>
        </div>
