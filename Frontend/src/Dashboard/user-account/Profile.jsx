...
const Profile = ({user}) => {
  ...
  useEffect(() => {
    setFormData({ name: user.name, email: user.email, photo:user.photo, gender: user.gender, 
      bloodType:user.bloodType, address: user.address})
  }, [user]);
        ...
        <div className='mb-5 flex items-center justify-between'>
          ...
          <label className='text-headingColor font-bold text-[16px] leading-7'>
            ...
            <select
              ...
              onChange={handleInputChange}
              className='text-textColor font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none flex items-center justify-center'>
